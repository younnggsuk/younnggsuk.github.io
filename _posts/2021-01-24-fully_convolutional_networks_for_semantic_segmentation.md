...
<figure>
  ...
  <figcaption><i><a href="https://stackoverflow.com/questions/40690951/how-does-shift-and-stitch-in-a-fully-convolutional-network-work" target="_blank" rel="noopener noreferrer">그림 출처 : https://stackoverflow.com/questions/40690951/how-does-shift-and-stitch-in-a-fully-convolutional-network-work</a></i></figcaption>
</figure>
...
(논문에서는 Deconvolution이라고 표기하였지만 수학적으로 엄밀하게 따졌을 때 Convolution의 역연산은 아니므로, Transposed Convolution이라고 부르는 것이 더 타당하다. 여기에 대한 자세한 설명은 <a href="https://www.slideshare.net/ssuserb208cc1/transposed-convolution" target="_blank" rel="noopener noreferrer">이곳</a>을 참고)
...
<figure>
  ...
  <figcaption><i><a href="https://arxiv.org/abs/1504.07947" target="_blank" rel="noopener noreferrer">그림 출처 : Patch-based Convolutional Neural Network for Whole Slide Tissue Image
