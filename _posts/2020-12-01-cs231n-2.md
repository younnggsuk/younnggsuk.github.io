...
![/assets/cs231n_eecs/ch2/l1_distance.png](/assets/cs231n_eecs/ch2/l1_distance.png){:style="border:1px solid black" width="377px"}
![/assets/cs231n_eecs/ch2/l2_distance.png](/assets/cs231n_eecs/ch2/l2_distance.png){:style="border:1px solid black" width="322px"}
...
- 그래프 이해에 참고한 블로그
  - [\[taewan.kim 블로그 - 딥러닝을 위한 Norm, 노름\]](http://taewan.kim/post/norm/)
