---
title: "[풀잎스쿨 14기] Multi-scale Context Aggregation by Dilated Convolutions"
key: 20210304
sidebar:
  nav: papers-ko
...
- 기존의 semantic segmentation 네트워크에서 사용한 **classification network를 front-end module과 같이 수정하여 성능을 향상**시킬 수 있다.
  - **Image classification을 위한 CNN 구조를 segmentation에 적합한 구조로 재설계했다는 점이 기존 연구들과의 큰 차이점**이며, 새로운 연구의 가능성을 열어줌
