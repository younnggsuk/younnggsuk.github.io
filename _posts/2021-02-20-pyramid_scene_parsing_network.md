---
title: "[풀잎스쿨 14기] Pyramid Scene Parsing Network"
key: 20210220
sidebar:
  nav: papers-ko
...
<p align="center">
<img src="/assets/pyramid_scene_parsing_network/pspnet_title.png" alt="segnet">
</p>
...
이 글은 <a href="https://arxiv.org/abs/1612.01105" target="_blank" rel="noopener noreferrer">Pyramid Scene Parsing Network</a> 논문을 읽고 정리한 것입니다. 이 글에 있는 대부분의 사진들은 논문에서 가져온 것임을 밝힙니다.
{:.info}

# Introduction

![fig_1](/assets/pyramid_scene_parsing_network/fig_1.png){:width="500px" style="border:1px solid black"}
...
![fig_2](/assets/pyramid_scene_parsing_network/fig_2.png){:style="border:1px solid black"}
...
![fig_3](/assets/pyramid_scene_parsing_network/fig_3.png){:style="border:1px solid black"}
...
![fig_4](/assets/pyramid_scene_parsing_network/fig_4.png){:width="500px" style="border:1px solid black"}
...
![table_1](/assets/pyramid_scene_parsing_network/table_1.png){:width="500px" style="border:1px solid black"}
...
![table_2](/assets/pyramid_scene_parsing_network/table_2.png){:width="500px" style="border:1px solid black"}
...
![fig_5](/assets/pyramid_scene_parsing_network/fig_5.png){:width="500px" style="border:1px solid black"}

![table_3](/assets/pyramid_scene_parsing_network/table_3.png){:width="500px" style="border:1px solid black"}
...
![table_4](/assets/pyramid_scene_parsing_network/table_4.png){:width="500px" style="border:1px solid black"}
...
![table_5](/assets/pyramid_scene_parsing_network/table_5.png){:width="500px" style="border:1px solid black"}

- *Table 5는* test set에서의 ImageNet scene parsing challenge 2016 순위이다.
  - **PSPNet이 가장 높은 점수**로 1위를 차지하였음

![fig_6](/assets/pyramid_scene_parsing_network/fig_6.png){:width="500px" style="border:1px solid black"}
...
![table_6](/assets/pyramid_scene_parsing_network/table_6.png){:style="border:1px solid black"}
...
![fig_7](/assets/pyramid_scene_parsing_network/fig_7.png){:width="500px" style="border:1px solid black"}
...
![fig_9](/assets/pyramid_scene_parsing_network/fig_9.png){:style="border:1px solid black"}

- *Figure 9*은 PASCAL VOC에서의 PSPNet을 포함한 여러 모델들의 segmentation 결과이다.

## Cityscapes

![table_7](/assets/pyramid_scene_parsing_network/table_7.png){:width="500px" style="border:1px solid black"}
...
![fig_8](/assets/pyramid_scene_parsing_network/fig_8.png){:width="500px" style="border:1px solid black"}
