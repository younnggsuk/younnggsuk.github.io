...
- Regularization은 Loss function에 Regularization항을 추가하는 방식으로 penalty를 주어서 모델이 간단해지도록 한다.
  - 위 슬라이드에서, $R(W)$가 추가된 regulari
<p align="center">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/h7iBpEHGVNc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</p>/assets/cs231n_eecs/ch3/Untitled.png){:style="border:1px solid black" width="700px"}
